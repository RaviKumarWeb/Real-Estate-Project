  ...
  return (
    <div className=" p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className=" flex flex-col gap-4">
        ...
        <Link
          to={"/create-listing"}
          className="bg-green-700 text-white p-3 rounded-lg uppercase text-center hover:op-95 font-semibold"
        >
          Create Listing
        </Link>
      </form>
      ...
      <p className=" font-semibold text-red-700 mt-5">{error ? error : ""}</p>
      ...
      {userListings && userListings.length > 0 && (
        <div className=" flex flex-col gap-4">
          ...
          {userListings.map((listing) => (
            <div
              key={listing._id}
              className=" font-semibold flex items-center justify-between border p-3 rounded-lg gap-4"
            >
